...
class Text2Python:
    ...
    def _run_python(self, *args: str, timeout: int = 300) -> PythonResult:
        ...
        try:
            ...
            return PythonResult(
                ...
                operation=" ".join(args), return_code=-1
            )
    ...
    def _run_tool(self, tool: str, *args: str, timeout: int = 300) -> PythonResult:
        ...
        try:
            ...
            return PythonResult(
                success=False, output="", error=str(e),
                operation=f"{tool} {' '.join(args)}", return_code=-1
            )
    ...
    def get_suggestions(self, partial: str = "") -> List[Tuple[str, str]]:
        ...
        if (self.working_dir / "tests").is_dir() or \
           list(self.working_dir.glob("test_*.py")):
