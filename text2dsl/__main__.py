...
""",
    ...
    parser.add_argument("command", nargs="*", help="Polecenie do wykonania")

    parser.add_argument("-d", "--directory", help="Katalog roboczy", default=None)
    ...
    parser.add_argument("-v", "--voice", action="store_true", help="Włącz tryb głosowy")

    parser.add_argument("-s", "--status", action="store_true", help="Pokaż status projektu")

    parser.add_argument("-q", "--quiet", action="store_true", help="Ciche wyjście")
    ...
    parser.add_argument("--no-suggestions", action="store_true", help="Nie pokazuj sugestii")

    parser.add_argument("--export", action="store_true", help="Eksportuj projekt do archiwum")
    ...
    parser.add_argument("-o", "--output", help="Ścieżka wyjściowa dla eksportu")

    parser.add_argument("--list-files", action="store_true", help="Lista plików w projekcie")

    parser.add_argument("--version", action="version", version="text2dsl 0.2.0")
